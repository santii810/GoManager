 ...
 *
 *
 * Esta clase implementa la union entre el controlador y la vista.
 * Esta clase es un singleton. Debes usar getInstance() para obtener la instancia del view manager
 * Las principales acciones son:
 * 1 Guardar variables del controler y hacerlas accesibles desde las vistas.
